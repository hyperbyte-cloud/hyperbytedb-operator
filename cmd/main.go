...
func main() {
	...
	// Only create the webhook server when webhooks are enabled.
	// Without cert-manager (e.g. Kind clusters) the serving certs won't exist
	// and controller-runtime will crash on startup trying to load them.
