...
func PeersConfigMapName(cluster *v1alpha1.ChinfluxCluster) string {
...
//
//	ordinal "0" -> "chinflux-0.chinflux-headless.ns.svc.cluster.local:8086"
//	ordinal "1" -> "chinflux-1.chinflux-headless.ns.svc.cluster.local:8086"
//
// The init container reads this to derive its own identity and peer list.
func BuildPeersConfigMap(cluster *v1alpha1.ChinfluxCluster, namespace string, replicas int32) *corev1.ConfigMap {
