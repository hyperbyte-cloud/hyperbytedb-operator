...
var _ = Describe("ChinfluxCluster Controller", func() {
	Context("When reconciling a single-node cluster", func() {
		...
		It("should create ConfigMap, PeersConfigMap, Services, and StatefulSet", func() {
			controllerReconciler := &ChinfluxClusterReconciler{
				Client:   k8sClient,
